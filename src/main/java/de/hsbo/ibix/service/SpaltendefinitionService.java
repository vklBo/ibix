...
/**
 * The Interface SpaltendefinitionService.
 */
public interface SpaltendefinitionService {
	...
	public void speicherSpaltendefinition(Spaltendefinition Spaltendefinition);
	...
	List<Spaltendefinition> findByNameOrTag(String filtertext);

	List<Spaltendefinition> findByTags(Set<String> tags);
}
